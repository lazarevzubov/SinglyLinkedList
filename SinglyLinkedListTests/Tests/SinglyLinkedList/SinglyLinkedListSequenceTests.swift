...
final class SinglyLinkedListSequenceTests: XCTestCase {
    ...
    func testEnumerated() {
        let thirdNode = Node(payload: 2)
        let secondNode = Node(payload: 1, nextNode: thirdNode)
        let firstNode = Node(payload: 0, nextNode: secondNode)
        let list = SinglyLinkedList(firstNode: firstNode)
    ...
    func testSorted() {
        let thirdNode = Node(payload: 1)
        let secondNode = Node(payload: 3, nextNode: thirdNode)
        let firstNode = Node(payload: 2, nextNode: secondNode)
        let list = SinglyLinkedList(firstNode: firstNode)
    ...
    func testElementsEqual() {
        let thirdNode1 = Node(payload: 3)
        let secondNode1 = Node(payload: 2, nextNode: thirdNode1)
        let firstNode1 = Node(payload: 1, nextNode: secondNode1)
        let list1 = SinglyLinkedList(firstNode: firstNode1)

        let thirdNode2 = Node(payload: 3)
        let secondNode2 = Node(payload: 2, nextNode: thirdNode2)
        let firstNode2 = Node(payload: 1, nextNode: secondNode2)
        ...
        let thirdNode3 = Node(payload: 2)
        let secondNode3 = Node(payload: 1, nextNode: thirdNode3)
        let firstNode3 = Node(payload: 3, nextNode: secondNode3)
        ...
        let secondNode4 = Node(payload: 2)
        let firstNode4 = Node(payload: 1, nextNode: secondNode4)
    ...
    func testElementsEqualBy() {
        let thirdNode1 = Node(payload: NonEquatableInt(value: 3))
        let secondNode1 = Node(payload: NonEquatableInt(value: 2), nextNode: thirdNode1)
        let firstNode1 = Node(payload: NonEquatableInt(value: 1), nextNode: secondNode1)
        let list1 = SinglyLinkedList(firstNode: firstNode1)

        let thirdNode2 = Node(payload: NonEquatableInt(value: 3))
        let secondNode2 = Node(payload: NonEquatableInt(value: 2), nextNode: thirdNode2)
        let firstNode2 = Node(payload: NonEquatableInt(value: 1), nextNode: secondNode2)
        let list2 = SinglyLinkedList(firstNode: firstNode2)
        ...
        let thirdNode3 = Node(payload: NonEquatableInt(value: 2))
        let secondNode3 = Node(payload: NonEquatableInt(value: 1), nextNode: thirdNode3)
        let firstNode3 = Node(payload: NonEquatableInt(value: 3), nextNode: secondNode3)
        let list3 = SinglyLinkedList(firstNode: firstNode3)
        ...
        let secondNode4 = Node(payload: NonEquatableInt(value: 2))
        let firstNode4 = Node(payload: NonEquatableInt(value: 1), nextNode: secondNode4)
        let list4 = SinglyLinkedList(firstNode: firstNode4)
    ...
    func testStartsWith() {
        ...
        let prefixSecondNode = Node(payload: secondPayload)
        let prefixFirstNode = Node(payload: firstPayload, nextNode: prefixSecondNode)
        ...
        let anotherNode = Node(payload: 4)
    ...
    func testLexicographicallyPrecedes() {
        let thirdNode = Node(payload: 5)
        let secondNode = Node(payload: 4, nextNode: thirdNode)
        let firstNode = Node(payload: 3, nextNode: secondNode)
        let list = SinglyLinkedList(firstNode: firstNode)

        let precedentSecondNode = Node(payload: 2)
        let precedentFirstNode = Node(payload: 1, nextNode: precedentSecondNode)
        ...
        let nonPrecedentSecondNode = Node(payload: 6)
        let nonPrecedentFirstNode = Node(payload: 7, nextNode: nonPrecedentSecondNode)
    ...
    func testLexicographicallyPrecedesBy() {
        let thirdNode = Node(payload: NonEquatableInt(value: 5))
        let secondNode = Node(payload: NonEquatableInt(value: 4), nextNode: thirdNode)
        let firstNode = Node(payload: NonEquatableInt(value: 3), nextNode: secondNode)
        let list = SinglyLinkedList(firstNode: firstNode)

        let precedentSecondNode = Node(payload: NonEquatableInt(value: 2))
        let precedentFirstNode = Node(payload: NonEquatableInt(value: 1), nextNode: precedentSecondNode)
        let precedentList = SinglyLinkedList(firstNode: precedentFirstNode)
        XCTAssertTrue(precedentList.lexicographicallyPrecedes(list) { $0.payload.value < $1.payload.value },
                      "A lecicographical precedence test unexpectedly fails for a lists which nodes knowingly form a natural sequence regarding its payload.")

        let nonPrecedentSecondNode = Node(payload: NonEquatableInt(value: 6))
        let nonPrecedentFirstNode = Node(payload: NonEquatableInt(value: 7), nextNode: nonPrecedentSecondNode)
        let nonPrecedentList = SinglyLinkedList(firstNode: nonPrecedentFirstNode)
    ...
    func testPrefix() {
        ...
        let firstNode1 = Node(payload: firstPayload)
        let list1 = SinglyLinkedList(firstNode: firstNode1)
        XCTAssertEqual(SinglyLinkedList(list.prefix(1)), list1, "A one item prefix doesn't equal to a list of the initial first node.")

        let secondNode2 = Node(payload: secondPayload)
        let firstNode2 = Node(payload: firstPayload, nextNode: secondNode2)
        let list2 = SinglyLinkedList(firstNode: firstNode2)
        ...
        let thirdNode3 = Node(payload: thirdPayload)
        let secondNode3 = Node(payload: secondPayload, nextNode: thirdNode3)
        let firstNode3 = Node(payload: firstPayload, nextNode: secondNode3)
        let list3 = SinglyLinkedList(firstNode: firstNode3)
    ...
    func testPrefixWhile() {
        ...
        XCTAssertEqual(list.prefix { $0.payload > thirdPayload }, [Node<Int>](), "An unexpected resulting array of nodes which prefixes a list with a given predicate.")
    }
    ...
    func testSuffix() {
        ...
        XCTAssertEqual(list.suffix(0), [Node<Int>](), "Non empty suffix array for a zero-length suffix.")
    ...
    func testSplit() {
        let tenthNode = Node(payload: 2)
        let ninthNode = Node(payload: 9, nextNode: tenthNode)
        let eighthNode = Node(payload: 8, nextNode: ninthNode)
        let seventhNode = Node(payload: 7, nextNode: eighthNode)
        let sixthNode = Node(payload: 2, nextNode: seventhNode)
        let fifthNode = Node(payload: 5, nextNode: sixthNode)
        let fourthNode = Node(payload: 4, nextNode: fifthNode)
